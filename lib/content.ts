...
export const story = {
  ...
  paragraphs: [
    {
      heading: "I came here as a refugee.",
      body: `I was born in Odesa, Ukraine, in 1972. My family were Jewish refugees who fled the Soviet Union when I was four years old. America took us in. We settled first in Detroit, then in Brooklyn. I owe everything I am to this country and to the people who built the systems that let a refugee kid become someone.`,
    },
    {
    ...
    },
    {
      ...
      body: `When the prosecutors came for me, Trump's people abandoned me. When I started telling the truth — to Rachel Maddow in January 2020, before the House Oversight Committee in March 2024, on the record at every chance — I expected the other side to want accountability. Some did. Many didn't. Both parties protect their own first. They are more loyal to each other than they are to you. I tried to do this work inside the Democratic Party. I'm done. I'm running as an Independent because I'm not a politician. I don't have loyalty to any real hardcore party. I'm not backed by corporations. I'm not backed by PACs. I'm backed by you.`,
    },
    {
      heading: "I started showing up.",
      body: `When I came home, I made a promise to myself. The next time the powerful were getting away with something, I wasn't going to be on the wrong side of it. I wrote Shadow Diplomacy with Jerry Langton. I sat for the MSNBC Films documentary From Russia with Lev. I built the Substack — Lev Remembers — and a daily livestream and the community I call the Wolfpack. We do the work the press won't do: covering the Epstein-files release, interviewing whistleblowers, delivering material directly to Congress. I sat in the House Oversight field hearing in West Palm Beach — twenty minutes from this district — and listened to Maria Farmer, Dani Bensky, Roza, Courtney Wild, Jena-Lisa Jones, and Sky and Daniel Roberts testify. I went to New York for the 24-hour reading of the 3.5 million pages. We are not going to let them use these survivors when it is politically useful and abandon them when it is time to stand. That's a promise.`,
    },
    {
